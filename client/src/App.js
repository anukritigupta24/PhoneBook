        ...
        return (
            <div className="App ">
                ...
                <div className="container-fluid" style={{width: "40%", margin: "auto"}}>
                    ...
                    <div className="row" >
                        <div hidden={!this.state.deleteStatus} className="alert alert-success" role="alert" style={{marginTop: "20px", marginLeft: "auto", marginRight: "auto"}}>
